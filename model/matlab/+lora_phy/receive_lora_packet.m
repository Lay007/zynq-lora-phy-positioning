...
acquisitionCheck = lora_phy.validate_acquisition_bins(preambleBins, ...
    syncBins, options.SyncWord, ...
    lora_phy.css_config(spreadingFactor, samplesPerChip));
preambleValid = acquisitionCheck.preambleValid;
syncValid = acquisitionCheck.syncValid;
