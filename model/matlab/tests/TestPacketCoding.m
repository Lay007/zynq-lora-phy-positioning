classdef TestPacketCoding < matlab.unittest.TestCase
    methods (Test)
        ...
        function hammingCodebookMatchesGoldenVector(testCase)
            expected = uint16(hex2dec(["00"; "17"; "2D"; "3A"; ...
                "4E"; "59"; "63"; "74"; "8B"; "9C"; "A6"; "B1"; ...
                "C5"; "D2"; "E8"; "FF"]));
        ...
        function fullPacketMatchesGoldenSymbols(testCase)
            ...
            expected = [125, 61, 5, 105, 61, 57, 81, 49, 86, 107, 86, ...
                87, 7, 103, 86, 58, 97, 99, 29, 49, 58, 120, 19, 32, ...
                35, 40, 76, 10, 86, 75, 85, 48, 127, 2, 0, 1, 32, 16].';
