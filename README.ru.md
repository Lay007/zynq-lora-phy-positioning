...
> и дробный ToA. В M3 сгенерирован Verilog и получены результаты out-of-context
> synthesis для восьми HDL-блоков, а для коррелятора и ToA есть core-only
> post-route timing и vectorless power. Ещё нужны cosimulation, упаковка IP и
> полный верхний уровень платы.
