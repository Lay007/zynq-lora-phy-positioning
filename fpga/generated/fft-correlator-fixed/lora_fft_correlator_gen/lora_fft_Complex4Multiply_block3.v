// -------------------------------------------------------------
// 
// File Name: G:\Programs\zynq-lora-phy-positioning\fpga\generated\fft-correlator-fixed\lora_fft_correlator_gen\lora_fft_Complex4Multiply_block3.v
...
// -------------------------------------------------------------
// 
// Module: lora_fft_Complex4Multiply_block3
// Source Path: lora_fft_correlator_gen/DUT/FFT_N/RADIX22FFT_SDF1_3/Complex4Multiply
// Hierarchy Level: 3
// Model version: 1.1
// 
// -------------------------------------------------------------
...
module lora_fft_Complex4Multiply_block3
  ...
  input   reset;
  input   enb;
  input   signed [18:0] din_re;  // sfix19_E1
  input   signed [18:0] din_im;  // sfix19_E1
  input   din_3_vld_dly;
  input   signed [15:0] twdl_3_1_re;  // sfix16_En14
  input   signed [15:0] twdl_3_1_im;  // sfix16_En14
  input   syncReset;
  output  signed [18:0] dinXTwdl_re;  // sfix19_E1
  output  signed [18:0] dinXTwdl_im;  // sfix19_E1
  output  dinXTwdl_3_1_vld;


  reg signed [18:0] din_re_reg;  // sfix19_E1
  reg signed [18:0] din_im_reg;  // sfix19_E1
  ...
  reg signed [34:0] prod1_re;  // sfix35_En13
  reg signed [34:0] prod1_im;  // sfix35_En13
  reg signed [34:0] prod2_re;  // sfix35_En13
  reg signed [34:0] prod2_im;  // sfix35_En13
  reg  din_vld_dly1;
  reg  din_vld_dly2;
  reg  din_vld_dly3;
  reg  prod_vld;
  ...
  wire signed [35:0] Complex4Add_multRes_re_reg_next;  // sfix36_En13
  wire signed [35:0] Complex4Add_multRes_im_reg_next;  // sfix36_En13
  wire signed [35:0] Complex4Add_sub_cast;  // sfix36_En13
  wire signed [35:0] Complex4Add_sub_cast_1;  // sfix36_En13
  wire signed [35:0] Complex4Add_add_cast;  // sfix36_En13
  wire signed [35:0] Complex4Add_add_cast_1;  // sfix36_En13
  wire signed [35:0] mulResFP_re;  // sfix36_En13
  wire signed [35:0] mulResFP_im;  // sfix36_En13
...
endmodule  // lora_fft_Complex4Multiply_block3
