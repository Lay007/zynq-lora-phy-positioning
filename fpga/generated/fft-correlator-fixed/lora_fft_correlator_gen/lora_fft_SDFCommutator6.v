// -------------------------------------------------------------
// 
// File Name: G:\Programs\zynq-lora-phy-positioning\fpga\generated\fft-correlator-fixed\lora_fft_correlator_gen\lora_fft_SDFCommutator6.v
...
// -------------------------------------------------------------
// 
// Module: lora_fft_SDFCommutator6
// Source Path: lora_fft_correlator_gen/DUT/FFT_M/RADIX22FFT_SDF2_6/SDFCommutator6
// Hierarchy Level: 3
// Model version: 1.1
// 
// -------------------------------------------------------------
...
module lora_fft_SDFCommutator6
  ...
  input   enb;
  input   dout_5_1_vld;
  input   signed [21:0] xf_re;  // sfix22_En10
  input   signed [21:0] xf_im;  // sfix22_En10
  input   xf_vld;
  input   signed [21:0] dinf_re;  // sfix22_En10
  input   signed [21:0] dinf_im;  // sfix22_En10
  input   dinf_vld;
  input   signed [21:0] btf1_re;  // sfix22_En10
  input   signed [21:0] btf1_im;  // sfix22_En10
  input   signed [21:0] btf2_re;  // sfix22_En10
  input   signed [21:0] btf2_im;  // sfix22_En10
  input   btfout_vld;
  input   syncReset;
  output  signed [21:0] wrData_re;  // sfix22_En10
  output  signed [21:0] wrData_im;  // sfix22_En10
  ...
  reg signed [21:0] SDFCummutator_out_re_next;  // sfix22_En10
  reg signed [21:0] SDFCummutator_out_im_next;  // sfix22_En10
  ...
  reg signed [21:0] SDFCummutator_wrData_re_reg_next;  // sfix22_En10
  reg signed [21:0] SDFCummutator_wrData_im_reg_next;  // sfix22_En10
  reg  SDFCummutator_wrEnb_reg_next;
  reg signed [21:0] SDFCummutator_wrXData_re_reg_next;  // sfix22_En10
  reg signed [21:0] SDFCummutator_wrXData_im_reg_next;  // sfix22_En10
  ...
  reg signed [21:0] wrData_re_1;  // sfix22_En10
  reg signed [21:0] wrData_im_1;  // sfix22_En10
  reg [3:0] wrAddr_1;  // ufix4
  reg  wrEnb_1;
  reg signed [21:0] xData_re;  // sfix22_En10
  reg signed [21:0] xData_im;  // sfix22_En10
  reg [2:0] wrXAddr;  // ufix3
  reg  wrXEnb;
  reg [2:0] rdXAddr;  // ufix3
  reg  xX_vld;
  reg signed [21:0] dout0_re;  // sfix22_En10
  reg signed [21:0] dout0_im;  // sfix22_En10
  reg  dout0_vld;
  wire signed [21:0] xX_re;  // sfix22_En10
  wire signed [21:0] xX_im;  // sfix22_En10
  reg signed [21:0] SDFOutmux_btf2Pipe_re;  // sfix22
  reg signed [21:0] SDFOutmux_btf2Pipe_im;  // sfix22
  reg  SDFOutmux_btfPipe_vld;
  reg signed [21:0] SDFOutmux_btf2Pipe_re_next;  // sfix22_En10
  reg signed [21:0] SDFOutmux_btf2Pipe_im_next;  // sfix22_En10
  reg  SDFOutmux_btfPipe_vld_next;
  reg signed [21:0] dout_6_1_re_1;  // sfix22_En10
  reg signed [21:0] dout_6_1_im_1;  // sfix22_En10
  reg  dout_6_1_vld_1;
...
endmodule  // lora_fft_SDFCommutator6
