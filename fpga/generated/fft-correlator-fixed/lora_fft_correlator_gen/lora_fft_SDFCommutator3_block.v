// -------------------------------------------------------------
// 
// File Name: G:\Programs\zynq-lora-phy-positioning\fpga\generated\fft-correlator-fixed\lora_fft_correlator_gen\lora_fft_SDFCommutator3_block.v
...
// -------------------------------------------------------------
// 
// Module: lora_fft_SDFCommutator3_block
// Source Path: lora_fft_correlator_gen/DUT/FFT_N/RADIX22FFT_SDF1_3/SDFCommutator3
// Hierarchy Level: 3
// Model version: 1.1
// 
// -------------------------------------------------------------
...
module lora_fft_SDFCommutator3_block
  ...
  input   enb;
  input   din_3_vld_dly;
  input   signed [18:0] xf_re;  // sfix19_E1
  input   signed [18:0] xf_im;  // sfix19_E1
  input   xf_vld;
  input   signed [18:0] dinXTwdlf_re;  // sfix19_E1
  input   signed [18:0] dinXTwdlf_im;  // sfix19_E1
  input   dinxTwdlf_vld;
  input   signed [18:0] btf1_re;  // sfix19_E1
  input   signed [18:0] btf1_im;  // sfix19_E1
  input   signed [18:0] btf2_re;  // sfix19_E1
  input   signed [18:0] btf2_im;  // sfix19_E1
  input   btf_vld;
  input   syncReset;
  output  signed [18:0] wrData_re;  // sfix19_E1
  output  signed [18:0] wrData_im;  // sfix19_E1
  ...
  reg signed [18:0] SDFCummutator_out_re_next;  // sfix19_E1
  reg signed [18:0] SDFCummutator_out_im_next;  // sfix19_E1
  ...
  reg signed [18:0] SDFCummutator_wrData_re_reg_next;  // sfix19_E1
  reg signed [18:0] SDFCummutator_wrData_im_reg_next;  // sfix19_E1
  reg  SDFCummutator_wrEnb_reg_next;
  reg signed [18:0] SDFCummutator_wrXData_re_reg_next;  // sfix19_E1
  reg signed [18:0] SDFCummutator_wrXData_im_reg_next;  // sfix19_E1
  ...
  reg signed [18:0] wrData_re_1;  // sfix19_E1
  reg signed [18:0] wrData_im_1;  // sfix19_E1
  reg [3:0] wrAddr_1;  // ufix4
  reg  wrEnb_1;
  reg signed [18:0] xData_re;  // sfix19_E1
  reg signed [18:0] xData_im;  // sfix19_E1
  reg [2:0] wrXAddr;  // ufix3
  reg  wrXEnb;
  reg [2:0] rdXAddr;  // ufix3
  reg  xX_vld;
  reg signed [18:0] dout0_re;  // sfix19_E1
  reg signed [18:0] dout0_im;  // sfix19_E1
  reg  dout0_vld;
  wire signed [18:0] xX_re;  // sfix19_E1
  wire signed [18:0] xX_im;  // sfix19_E1
  reg signed [18:0] SDFOutmux_btf2Pipe_re;  // sfix19
  reg signed [18:0] SDFOutmux_btf2Pipe_im;  // sfix19
  reg  SDFOutmux_btfPipe_vld;
  reg signed [18:0] SDFOutmux_btf2Pipe_re_next;  // sfix19_E1
  reg signed [18:0] SDFOutmux_btf2Pipe_im_next;  // sfix19_E1
  reg  SDFOutmux_btfPipe_vld_next;
  reg signed [18:0] dout_3_1_re_1;  // sfix19_E1
  reg signed [18:0] dout_3_1_im_1;  // sfix19_E1
  reg  dout_3_1_vld_1;
...
endmodule  // lora_fft_SDFCommutator3_block
