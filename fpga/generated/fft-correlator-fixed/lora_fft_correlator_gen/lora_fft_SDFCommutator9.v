// -------------------------------------------------------------
// 
// File Name: G:\Programs\zynq-lora-phy-positioning\fpga\generated\fft-correlator-fixed\lora_fft_correlator_gen\lora_fft_SDFCommutator9.v
...
// -------------------------------------------------------------
// 
// Module: lora_fft_SDFCommutator9
// Source Path: lora_fft_correlator_gen/DUT/FFT_M/RADIX22FFT_SDF1_9/SDFCommutator9
// Hierarchy Level: 3
// Model version: 1.1
// 
// -------------------------------------------------------------
...
module lora_fft_SDFCommutator9
  ...
  input   enb;
  input   din_9_vld_dly;
  input   signed [24:0] xf_re;  // sfix25_En10
  input   signed [24:0] xf_im;  // sfix25_En10
  input   xf_vld;
  input   signed [24:0] dinXTwdlf_re;  // sfix25_En10
  input   signed [24:0] dinXTwdlf_im;  // sfix25_En10
  input   dinxTwdlf_vld;
  input   signed [24:0] btf1_re;  // sfix25_En10
  input   signed [24:0] btf1_im;  // sfix25_En10
  input   signed [24:0] btf2_re;  // sfix25_En10
  input   signed [24:0] btf2_im;  // sfix25_En10
  input   btf_vld;
  input   syncReset;
  output  signed [24:0] wrData_re;  // sfix25_En10
  output  signed [24:0] wrData_im;  // sfix25_En10
  output  wrAddr;  // ufix1
  output  wrEnb;
  ...
  reg signed [24:0] SDFCummutator_out_re_next;  // sfix25_En10
  reg signed [24:0] SDFCummutator_out_im_next;  // sfix25_En10
  reg  SDFCummutator_out_vld_next;
  reg  SDFCummutator_wrAddr_reg_next;  // ufix1
  reg [2:0] SDFCummutator_wrState_next;  // ufix3
  reg signed [24:0] SDFCummutator_wrData_re_reg_next;  // sfix25_En10
  reg signed [24:0] SDFCummutator_wrData_im_reg_next;  // sfix25_En10
  reg  SDFCummutator_wrEnb_reg_next;
  reg signed [24:0] SDFCummutator_wrXData_re_reg_next;  // sfix25_En10
  reg signed [24:0] SDFCummutator_wrXData_im_reg_next;  // sfix25_En10
  ...
  reg signed [24:0] wrData_re_1;  // sfix25_En10
  reg signed [24:0] wrData_im_1;  // sfix25_En10
  reg  wrAddr_1;  // ufix1
  reg  wrEnb_1;
  reg signed [24:0] xData_re;  // sfix25_En10
  reg signed [24:0] xData_im;  // sfix25_En10
  reg [2:0] wrXAddr;  // ufix3
  reg  wrXEnb;
  reg [2:0] rdXAddr;  // ufix3
  reg  xX_vld;
  reg signed [24:0] dout0_re;  // sfix25_En10
  reg signed [24:0] dout0_im;  // sfix25_En10
  reg  dout0_vld;
  wire signed [24:0] xX_re;  // sfix25_En10
  wire signed [24:0] xX_im;  // sfix25_En10
  reg signed [24:0] SDFOutmux_btf2Pipe_re;  // sfix25
  reg signed [24:0] SDFOutmux_btf2Pipe_im;  // sfix25
  reg  SDFOutmux_btfPipe_vld;
  reg signed [24:0] SDFOutmux_btf2Pipe_re_next;  // sfix25_En10
  reg signed [24:0] SDFOutmux_btf2Pipe_im_next;  // sfix25_En10
  reg  SDFOutmux_btfPipe_vld_next;
  reg signed [24:0] dout_9_1_re_1;  // sfix25_En10
  reg signed [24:0] dout_9_1_im_1;  // sfix25_En10
  reg  dout_9_1_vld_1;
...
endmodule  // lora_fft_SDFCommutator9
