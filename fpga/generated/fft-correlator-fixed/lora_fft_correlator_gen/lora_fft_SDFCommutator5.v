// -------------------------------------------------------------
// 
// File Name: G:\Programs\zynq-lora-phy-positioning\fpga\generated\fft-correlator-fixed\lora_fft_correlator_gen\lora_fft_SDFCommutator5.v
...
// -------------------------------------------------------------
// 
// Module: lora_fft_SDFCommutator5
// Source Path: lora_fft_correlator_gen/DUT/FFT_M/RADIX22FFT_SDF1_5/SDFCommutator5
// Hierarchy Level: 3
// Model version: 1.1
// 
// -------------------------------------------------------------
...
module lora_fft_SDFCommutator5
  ...
  input   enb;
  input   din_5_vld_dly;
  input   signed [20:0] xf_re;  // sfix21_En10
  input   signed [20:0] xf_im;  // sfix21_En10
  input   xf_vld;
  input   signed [20:0] dinXTwdlf_re;  // sfix21_En10
  input   signed [20:0] dinXTwdlf_im;  // sfix21_En10
  input   dinxTwdlf_vld;
  input   signed [20:0] btf1_re;  // sfix21_En10
  input   signed [20:0] btf1_im;  // sfix21_En10
  input   signed [20:0] btf2_re;  // sfix21_En10
  input   signed [20:0] btf2_im;  // sfix21_En10
  input   btf_vld;
  input   syncReset;
  output  signed [20:0] wrData_re;  // sfix21_En10
  output  signed [20:0] wrData_im;  // sfix21_En10
  ...
  reg signed [20:0] SDFCummutator_out_re_next;  // sfix21_En10
  reg signed [20:0] SDFCummutator_out_im_next;  // sfix21_En10
  ...
  reg signed [20:0] SDFCummutator_wrData_re_reg_next;  // sfix21_En10
  reg signed [20:0] SDFCummutator_wrData_im_reg_next;  // sfix21_En10
  reg  SDFCummutator_wrEnb_reg_next;
  reg signed [20:0] SDFCummutator_wrXData_re_reg_next;  // sfix21_En10
  reg signed [20:0] SDFCummutator_wrXData_im_reg_next;  // sfix21_En10
  ...
  reg signed [20:0] wrData_re_1;  // sfix21_En10
  reg signed [20:0] wrData_im_1;  // sfix21_En10
  reg [4:0] wrAddr_1;  // ufix5
  reg  wrEnb_1;
  reg signed [20:0] xData_re;  // sfix21_En10
  reg signed [20:0] xData_im;  // sfix21_En10
  reg [2:0] wrXAddr;  // ufix3
  reg  wrXEnb;
  reg [2:0] rdXAddr;  // ufix3
  reg  xX_vld;
  reg signed [20:0] dout0_re;  // sfix21_En10
  reg signed [20:0] dout0_im;  // sfix21_En10
  reg  dout0_vld;
  wire signed [20:0] xX_re;  // sfix21_En10
  wire signed [20:0] xX_im;  // sfix21_En10
  reg signed [20:0] SDFOutmux_btf2Pipe_re;  // sfix21
  reg signed [20:0] SDFOutmux_btf2Pipe_im;  // sfix21
  reg  SDFOutmux_btfPipe_vld;
  reg signed [20:0] SDFOutmux_btf2Pipe_re_next;  // sfix21_En10
  reg signed [20:0] SDFOutmux_btf2Pipe_im_next;  // sfix21_En10
  reg  SDFOutmux_btfPipe_vld_next;
  reg signed [20:0] dout_5_1_re_1;  // sfix21_En10
  reg signed [20:0] dout_5_1_im_1;  // sfix21_En10
  reg  dout_5_1_vld_1;
...
endmodule  // lora_fft_SDFCommutator5
