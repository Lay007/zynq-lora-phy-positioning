// -------------------------------------------------------------
// 
// File Name: G:\Programs\zynq-lora-phy-positioning\fpga\generated\fft-correlator-fixed\lora_fft_correlator_gen\lora_fft_RADIX22FFT_SDF1_1.v
...
// -------------------------------------------------------------
// 
// Module: lora_fft_RADIX22FFT_SDF1_1
...
module lora_fft_RADIX22FFT_SDF1_1
  ...
  lora_fft_SimpleDualPortRAM_generic #(.AddrWidth(9),
                                       .DataWidth(17)
                                       )
  ...
  lora_fft_SDFCommutator1 u_SDFCOMMUTATOR_1 (.clk(clk),
                                             .reset(reset),
                                             .enb(enb),
...
endmodule  // lora_fft_RADIX22FFT_SDF1_1
