// -------------------------------------------------------------
// 
// File Name: G:\Programs\zynq-lora-phy-positioning\fpga\generated\fft-correlator-fixed\lora_fft_correlator_gen\lora_fft_RADIX2FFT_bitNatural_block.v
...
// -------------------------------------------------------------
// 
// Module: lora_fft_RADIX2FFT_bitNatural_block
// Source Path: lora_fft_correlator_gen/DUT/FFT_N/RADIX2FFT_bitNatural
// Hierarchy Level: 2
// Model version: 1.1
// 
// -------------------------------------------------------------
...
module lora_fft_RADIX2FFT_bitNatural_block
  ...
  input   reset;
  input   enb;
  input   signed [22:0] dout_7_re;  // sfix23_E1
  input   signed [22:0] dout_7_im;  // sfix23_E1
  input   dout_7_vld;
  input   syncReset;
  output  signed [22:0] dout_re1;  // sfix23_E1
  output  signed [22:0] dout_im1;  // sfix23_E1
  output  dout_vld1;
  ...
  wire signed [22:0] memOut_im;  // sfix23_E1
  wire signed [22:0] memOut_re;  // sfix23_E1
  ...
  reg signed [22:0] rdStateMachineBitNatural_doutReReg_next;  // sfix23_E1
  reg signed [22:0] rdStateMachineBitNatural_doutImReg_next;  // sfix23_E1
  ...
  reg signed [22:0] dout_re1_1;  // sfix23_E1
  reg signed [22:0] dout_im1_1;  // sfix23_E1
  reg  dout_vld1_1;
  reg  startOutW;
  reg  endOutW;
...
endmodule  // lora_fft_RADIX2FFT_bitNatural_block
