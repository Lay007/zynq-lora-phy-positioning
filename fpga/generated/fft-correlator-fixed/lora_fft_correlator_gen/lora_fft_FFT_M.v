// -------------------------------------------------------------
// 
// File Name: G:\Programs\zynq-lora-phy-positioning\fpga\generated\fft-correlator-fixed\lora_fft_correlator_gen\lora_fft_FFT_M.v
// Created: 2026-08-27 23:28:37
// 
...
module lora_fft_FFT_M
  ...
  lora_fft_RADIX22FFT_CTRL1_1 u_CTRL1_1_1 (.clk(clk),
                                           .reset(reset),
                                           .enb(enb),
  ...
  lora_fft_RADIX22FFT_SDF1_1 u_SDF1_1_1 (.clk(clk),
                                         .reset(reset),
                                         .enb(enb),
  ...
  lora_fft_RADIX22FFT_CTRL1_2 u_CTRL2_2_1 (.clk(clk),
                                           .reset(reset),
                                           .enb(enb),
                                           .dout_1_1_vld(dout_1_1_vld),
  ...
  lora_fft_RADIX22FFT_SDF2_2 u_SDF2_2_1 (.clk(clk),
                                         .reset(reset),
                                         .enb(enb),
                                         .dout_1_1_re(dout_1_1_re),  // sfix17_En10
                                         .dout_1_1_im(dout_1_1_im),  // sfix17_En10
  ...
  lora_fft_TWDLROM_3_1 u_twdlROM_3_1 (.clk(clk),
                                      .reset(reset),
                                      .enb(enb),
                                      .dout_2_1_vld(dout_2_1_vld),
                                      .syncReset(syncReset),
  ...
  lora_fft_RADIX22FFT_CTRL1_3 u_CTRL1_3_1 (.clk(clk),
                                           .reset(reset),
                                           .enb(enb),
  ...
  lora_fft_RADIX22FFT_SDF1_3 u_SDF1_3_1 (.clk(clk),
                                         .reset(reset),
                                         .enb(enb),
  ...
  lora_fft_RADIX22FFT_CTRL1_4 u_CTRL2_4_1 (.clk(clk),
                                           .reset(reset),
                                           .enb(enb),
                                           .dout_3_1_vld(dout_3_1_vld),
  ...
  lora_fft_RADIX22FFT_SDF2_4 u_SDF2_4_1 (.clk(clk),
                                         .reset(reset),
                                         .enb(enb),
                                         .dout_3_1_re(dout_3_1_re),  // sfix19_En10
                                         .dout_3_1_im(dout_3_1_im),  // sfix19_En10
  ...
  lora_fft_TWDLROM_5_1 u_twdlROM_5_1 (.clk(clk),
                                      .reset(reset),
                                      .enb(enb),
                                      .dout_4_1_vld(dout_4_1_vld),
                                      .syncReset(syncReset),
  ...
  lora_fft_RADIX22FFT_CTRL1_5 u_CTRL1_5_1 (.clk(clk),
                                           .reset(reset),
                                           .enb(enb),
  ...
  lora_fft_RADIX22FFT_SDF1_5 u_SDF1_5_1 (.clk(clk),
                                         .reset(reset),
                                         .enb(enb),
  ...
  lora_fft_RADIX22FFT_CTRL1_6 u_CTRL2_6_1 (.clk(clk),
                                           .reset(reset),
                                           .enb(enb),
                                           .dout_5_1_vld(dout_5_1_vld),
  ...
  lora_fft_RADIX22FFT_SDF2_6 u_SDF2_6_1 (.clk(clk),
                                         .reset(reset),
                                         .enb(enb),
                                         .dout_5_1_re(dout_5_1_re),  // sfix21_En10
                                         .dout_5_1_im(dout_5_1_im),  // sfix21_En10
  ...
  lora_fft_TWDLROM_7_1 u_twdlROM_7_1 (.clk(clk),
                                      .reset(reset),
                                      .enb(enb),
                                      .dout_6_1_vld(dout_6_1_vld),
                                      .syncReset(syncReset),
  ...
  lora_fft_RADIX22FFT_CTRL1_7 u_CTRL1_7_1 (.clk(clk),
                                           .reset(reset),
                                           .enb(enb),
  ...
  lora_fft_RADIX22FFT_SDF1_7 u_SDF1_7_1 (.clk(clk),
                                         .reset(reset),
                                         .enb(enb),
  ...
  lora_fft_RADIX22FFT_CTRL1_8 u_CTRL2_8_1 (.clk(clk),
                                           .reset(reset),
                                           .enb(enb),
                                           .dout_7_1_vld(dout_7_1_vld),
  ...
  lora_fft_RADIX22FFT_SDF2_8 u_SDF2_8_1 (.clk(clk),
                                         .reset(reset),
                                         .enb(enb),
                                         .dout_7_1_re(dout_7_1_re),  // sfix23_En10
                                         .dout_7_1_im(dout_7_1_im),  // sfix23_En10
  ...
  lora_fft_TWDLROM_9_1 u_twdlROM_9_1 (.clk(clk),
                                      .reset(reset),
                                      .enb(enb),
                                      .dout_8_1_vld(dout_8_1_vld),
                                      .syncReset(syncReset),
  ...
  lora_fft_RADIX22FFT_CTRL1_9 u_CTRL1_9_1 (.clk(clk),
                                           .reset(reset),
                                           .enb(enb),
  ...
  lora_fft_RADIX22FFT_SDF1_9 u_SDF1_9_1 (.clk(clk),
                                         .reset(reset),
                                         .enb(enb),
  ...
  lora_fft_RADIX22FFT_CTRL1_10 u_CTRL2_10_1 (.clk(clk),
                                             .reset(reset),
                                             .enb(enb),
                                             .dout_9_1_vld(dout_9_1_vld),
  ...
  lora_fft_RADIX22FFT_SDF2_10 u_SDF2_10_1 (.clk(clk),
                                           .reset(reset),
                                           .enb(enb),
                                           .dout_9_1_re(dout_9_1_re),  // sfix25_En10
                                           .dout_9_1_im(dout_9_1_im),  // sfix25_En10
  ...
  lora_fft_RADIX2FFT_bitNatural u_NaturalOrder_Stage (.clk(clk),
                                                      .reset(reset),
                                                      .enb(enb),
                                                      .dout_10_1_re(dout_10_1_re),  // sfix26_En10
                                                      .dout_10_1_im(dout_10_1_im),  // sfix26_En10
