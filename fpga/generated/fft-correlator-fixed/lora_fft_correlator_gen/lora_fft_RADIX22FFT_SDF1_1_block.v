// -------------------------------------------------------------
// 
// File Name: G:\Programs\zynq-lora-phy-positioning\fpga\generated\fft-correlator-fixed\lora_fft_correlator_gen\lora_fft_RADIX22FFT_SDF1_1_block.v
...
// -------------------------------------------------------------
// 
// Module: lora_fft_RADIX22FFT_SDF1_1_block
// Source Path: lora_fft_correlator_gen/DUT/FFT_N/RADIX22FFT_SDF1_1
// Hierarchy Level: 2
// Model version: 1.1
// 
// -------------------------------------------------------------
...
module lora_fft_RADIX22FFT_SDF1_1_block
  ...
  input   reset;
  input   enb;
  input   signed [15:0] din_1_1_re_dly;  // sfix16_E1
  input   signed [15:0] din_1_1_im_dly;  // sfix16_E1
  input   din_1_vld_dly;
  input   [5:0] rd_1_Addr;  // ufix6
  input   rd_1_Enb;
  input   proc_1_enb;
  input   syncReset;
  output  signed [16:0] dout_1_1_re;  // sfix17_E1
  output  signed [16:0] dout_1_1_im;  // sfix17_E1
  output  dout_1_1_vld;
  output  dinXTwdl_1_1_vld;


  wire signed [16:0] din_re;  // sfix17_E1
  reg signed [16:0] dinXTwdl_re;  // sfix17_E1
  wire signed [16:0] din_im;  // sfix17_E1
  reg signed [16:0] dinXTwdl_im;  // sfix17_E1
  reg  dinXTwdl_1_1_vld_1;
  reg  x_vld;
  wire signed [16:0] wrData_im;  // sfix17_E1
  wire [5:0] wrAddr;  // ufix6
  wire wrEnb;
  wire signed [16:0] x_im;  // sfix17_E1
  wire signed [16:0] wrData_re;  // sfix17_E1
  wire signed [16:0] x_re;  // sfix17_E1
  ...
  wire signed [17:0] Radix22ButterflyG1_btf1_re_reg_next;  // sfix18_E1
  wire signed [17:0] Radix22ButterflyG1_btf1_im_reg_next;  // sfix18_E1
  wire signed [17:0] Radix22ButterflyG1_btf2_re_reg_next;  // sfix18_E1
  wire signed [17:0] Radix22ButterflyG1_btf2_im_reg_next;  // sfix18_E1
  wire signed [17:0] Radix22ButterflyG1_add_cast;  // sfix18_E1
  wire signed [17:0] Radix22ButterflyG1_add_cast_1;  // sfix18_E1
  wire signed [17:0] Radix22ButterflyG1_sub_cast;  // sfix18_E1
  wire signed [17:0] Radix22ButterflyG1_sub_cast_1;  // sfix18_E1
  wire signed [17:0] Radix22ButterflyG1_add_cast_2;  // sfix18_E1
  wire signed [17:0] Radix22ButterflyG1_add_cast_3;  // sfix18_E1
  wire signed [17:0] Radix22ButterflyG1_sub_cast_2;  // sfix18_E1
  wire signed [17:0] Radix22ButterflyG1_sub_cast_3;  // sfix18_E1
  reg signed [16:0] xf_re;  // sfix17_E1
  reg signed [16:0] xf_im;  // sfix17_E1
  reg  xf_vld;
  wire signed [16:0] dinXTwdlf_re;  // sfix17_E1
  wire signed [16:0] dinXTwdlf_im;  // sfix17_E1
  wire dinxTwdlf_vld;
  wire signed [16:0] btf1_re;  // sfix17_E1
  wire signed [16:0] btf1_im;  // sfix17_E1
  wire signed [16:0] btf2_re;  // sfix17_E1
  wire signed [16:0] btf2_im;  // sfix17_E1
  reg  btf_vld;
  ...
  lora_fft_SDFCommutator1_block u_SDFCOMMUTATOR_1 (.clk(clk),
                                                   .reset(reset),
                                                   .enb(enb),
                                                   .din_1_vld_dly(din_1_vld_dly),
                                                   .xf_re(xf_re),  // sfix17_E1
                                                   .xf_im(xf_im),  // sfix17_E1
                                                   .xf_vld(xf_vld),
                                                   .dinXTwdlf_re(dinXTwdlf_re),  // sfix17_E1
                                                   .dinXTwdlf_im(dinXTwdlf_im),  // sfix17_E1
                                                   .dinxTwdlf_vld(dinxTwdlf_vld),
                                                   .btf1_re(btf1_re),  // sfix17_E1
                                                   .btf1_im(btf1_im),  // sfix17_E1
                                                   .btf2_re(btf2_re),  // sfix17_E1
                                                   .btf2_im(btf2_im),  // sfix17_E1
                                                   .btf_vld(btf_vld),
                                                   .syncReset(syncReset),
                                                   .wrData_re(wrData_re),  // sfix17_E1
                                                   .wrData_im(wrData_im),  // sfix17_E1
                                                   .wrAddr(wrAddr),  // ufix6
                                                   .wrEnb(wrEnb),
...
endmodule  // lora_fft_RADIX22FFT_SDF1_1_block
