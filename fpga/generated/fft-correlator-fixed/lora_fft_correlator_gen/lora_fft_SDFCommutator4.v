// -------------------------------------------------------------
// 
// File Name: G:\Programs\zynq-lora-phy-positioning\fpga\generated\fft-correlator-fixed\lora_fft_correlator_gen\lora_fft_SDFCommutator4.v
...
// -------------------------------------------------------------
// 
// Module: lora_fft_SDFCommutator4
// Source Path: lora_fft_correlator_gen/DUT/FFT_M/RADIX22FFT_SDF2_4/SDFCommutator4
// Hierarchy Level: 3
// Model version: 1.1
// 
// -------------------------------------------------------------
...
module lora_fft_SDFCommutator4
  ...
  input   enb;
  input   dout_3_1_vld;
  input   signed [19:0] xf_re;  // sfix20_En10
  input   signed [19:0] xf_im;  // sfix20_En10
  input   xf_vld;
  input   signed [19:0] dinf_re;  // sfix20_En10
  input   signed [19:0] dinf_im;  // sfix20_En10
  input   dinf_vld;
  input   signed [19:0] btf1_re;  // sfix20_En10
  input   signed [19:0] btf1_im;  // sfix20_En10
  input   signed [19:0] btf2_re;  // sfix20_En10
  input   signed [19:0] btf2_im;  // sfix20_En10
  input   btfout_vld;
  input   syncReset;
  output  signed [19:0] wrData_re;  // sfix20_En10
  output  signed [19:0] wrData_im;  // sfix20_En10
  ...
  reg signed [19:0] SDFCummutator_out_re_next;  // sfix20_En10
  reg signed [19:0] SDFCummutator_out_im_next;  // sfix20_En10
  ...
  reg signed [19:0] SDFCummutator_wrData_re_reg_next;  // sfix20_En10
  reg signed [19:0] SDFCummutator_wrData_im_reg_next;  // sfix20_En10
  reg  SDFCummutator_wrEnb_reg_next;
  reg signed [19:0] SDFCummutator_wrXData_re_reg_next;  // sfix20_En10
  reg signed [19:0] SDFCummutator_wrXData_im_reg_next;  // sfix20_En10
  ...
  reg signed [19:0] wrData_re_1;  // sfix20_En10
  reg signed [19:0] wrData_im_1;  // sfix20_En10
  reg [5:0] wrAddr_1;  // ufix6
  reg  wrEnb_1;
  reg signed [19:0] xData_re;  // sfix20_En10
  reg signed [19:0] xData_im;  // sfix20_En10
  reg [2:0] wrXAddr;  // ufix3
  reg  wrXEnb;
  reg [2:0] rdXAddr;  // ufix3
  reg  xX_vld;
  reg signed [19:0] dout0_re;  // sfix20_En10
  reg signed [19:0] dout0_im;  // sfix20_En10
  reg  dout0_vld;
  wire signed [19:0] xX_re;  // sfix20_En10
  wire signed [19:0] xX_im;  // sfix20_En10
  reg signed [19:0] SDFOutmux_btf2Pipe_re;  // sfix20
  reg signed [19:0] SDFOutmux_btf2Pipe_im;  // sfix20
  reg  SDFOutmux_btfPipe_vld;
  reg signed [19:0] SDFOutmux_btf2Pipe_re_next;  // sfix20_En10
  reg signed [19:0] SDFOutmux_btf2Pipe_im_next;  // sfix20_En10
  reg  SDFOutmux_btfPipe_vld_next;
  reg signed [19:0] dout_4_1_re_1;  // sfix20_En10
  reg signed [19:0] dout_4_1_im_1;  // sfix20_En10
  reg  dout_4_1_vld_1;
...
endmodule  // lora_fft_SDFCommutator4
