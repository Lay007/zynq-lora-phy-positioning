// -------------------------------------------------------------
// 
// File Name: G:\Programs\zynq-lora-phy-positioning\fpga\generated\fft-correlator-fixed\lora_fft_correlator_gen\lora_fft_SDFCommutator2_block.v
...
// -------------------------------------------------------------
// 
// Module: lora_fft_SDFCommutator2_block
// Source Path: lora_fft_correlator_gen/DUT/FFT_N/RADIX22FFT_SDF2_2/SDFCommutator2
// Hierarchy Level: 3
// Model version: 1.1
// 
// -------------------------------------------------------------
...
module lora_fft_SDFCommutator2_block
  ...
  input   enb;
  input   dout_1_1_vld;
  input   signed [17:0] xf_re;  // sfix18_E1
  input   signed [17:0] xf_im;  // sfix18_E1
  input   xf_vld;
  input   signed [17:0] dinf_re;  // sfix18_E1
  input   signed [17:0] dinf_im;  // sfix18_E1
  input   dinf_vld;
  input   signed [17:0] btf1_re;  // sfix18_E1
  input   signed [17:0] btf1_im;  // sfix18_E1
  input   signed [17:0] btf2_re;  // sfix18_E1
  input   signed [17:0] btf2_im;  // sfix18_E1
  input   btfout_vld;
  input   syncReset;
  output  signed [17:0] wrData_re;  // sfix18_E1
  output  signed [17:0] wrData_im;  // sfix18_E1
  ...
  reg signed [17:0] SDFCummutator_out_re_next;  // sfix18_E1
  reg signed [17:0] SDFCummutator_out_im_next;  // sfix18_E1
  ...
  reg signed [17:0] SDFCummutator_wrData_re_reg_next;  // sfix18_E1
  reg signed [17:0] SDFCummutator_wrData_im_reg_next;  // sfix18_E1
  reg  SDFCummutator_wrEnb_reg_next;
  reg signed [17:0] SDFCummutator_wrXData_re_reg_next;  // sfix18_E1
  reg signed [17:0] SDFCummutator_wrXData_im_reg_next;  // sfix18_E1
  ...
  reg signed [17:0] wrData_re_1;  // sfix18_E1
  reg signed [17:0] wrData_im_1;  // sfix18_E1
  reg [4:0] wrAddr_1;  // ufix5
  reg  wrEnb_1;
  reg signed [17:0] xData_re;  // sfix18_E1
  reg signed [17:0] xData_im;  // sfix18_E1
  reg [2:0] wrXAddr;  // ufix3
  reg  wrXEnb;
  reg [2:0] rdXAddr;  // ufix3
  reg  xX_vld;
  reg signed [17:0] dout0_re;  // sfix18_E1
  reg signed [17:0] dout0_im;  // sfix18_E1
  reg  dout0_vld;
  wire signed [17:0] xX_re;  // sfix18_E1
  wire signed [17:0] xX_im;  // sfix18_E1
  reg signed [17:0] SDFOutmux_btf2Pipe_re;  // sfix18
  reg signed [17:0] SDFOutmux_btf2Pipe_im;  // sfix18
  reg  SDFOutmux_btfPipe_vld;
  reg signed [17:0] SDFOutmux_btf2Pipe_re_next;  // sfix18_E1
  reg signed [17:0] SDFOutmux_btf2Pipe_im_next;  // sfix18_E1
  reg  SDFOutmux_btfPipe_vld_next;
  reg signed [17:0] dout_2_1_re_1;  // sfix18_E1
  reg signed [17:0] dout_2_1_im_1;  // sfix18_E1
  reg  dout_2_1_vld_1;
...
endmodule  // lora_fft_SDFCommutator2_block
