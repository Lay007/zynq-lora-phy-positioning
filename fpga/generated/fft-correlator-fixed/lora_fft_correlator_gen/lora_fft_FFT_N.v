// -------------------------------------------------------------
// 
// File Name: G:\Programs\zynq-lora-phy-positioning\fpga\generated\fft-correlator-fixed\lora_fft_correlator_gen\lora_fft_FFT_N.v
...
module lora_fft_FFT_N
  ...
  lora_fft_RADIX22FFT_CTRL1_1_block u_CTRL1_1_1 (.clk(clk),
                                                 .reset(reset),
                                                 .enb(enb),
  ...
  lora_fft_RADIX22FFT_SDF1_1_block u_SDF1_1_1 (.clk(clk),
                                               .reset(reset),
                                               .enb(enb),
  ...
  lora_fft_RADIX22FFT_CTRL1_2_block u_CTRL2_2_1 (.clk(clk),
                                                 .reset(reset),
                                                 .enb(enb),
                                                 .dout_1_1_vld(dout_1_1_vld),
  ...
  lora_fft_RADIX22FFT_SDF2_2_block u_SDF2_2_1 (.clk(clk),
                                               .reset(reset),
                                               .enb(enb),
                                               .dout_1_1_re(dout_1_1_re),  // sfix17_E1
                                               .dout_1_1_im(dout_1_1_im),  // sfix17_E1
  ...
  lora_fft_TWDLROM_3_1_block u_twdlROM_3_1 (.clk(clk),
                                            .reset(reset),
                                            .enb(enb),
                                            .dout_2_1_vld(dout_2_1_vld),
                                            .syncReset(syncReset),
  ...
  lora_fft_RADIX22FFT_CTRL1_3_block u_CTRL1_3_1 (.clk(clk),
                                                 .reset(reset),
                                                 .enb(enb),
  ...
  lora_fft_RADIX22FFT_SDF1_3_block u_SDF1_3_1 (.clk(clk),
                                               .reset(reset),
                                               .enb(enb),
  ...
  lora_fft_RADIX22FFT_CTRL1_4_block u_CTRL2_4_1 (.clk(clk),
                                                 .reset(reset),
                                                 .enb(enb),
                                                 .dout_3_1_vld(dout_3_1_vld),
  ...
  lora_fft_RADIX22FFT_SDF2_4_block u_SDF2_4_1 (.clk(clk),
                                               .reset(reset),
                                               .enb(enb),
                                               .dout_3_1_re(dout_3_1_re),  // sfix19_E1
                                               .dout_3_1_im(dout_3_1_im),  // sfix19_E1
  ...
  lora_fft_TWDLROM_5_1_block u_twdlROM_5_1 (.clk(clk),
                                            .reset(reset),
                                            .enb(enb),
                                            .dout_4_1_vld(dout_4_1_vld),
                                            .syncReset(syncReset),
  ...
  lora_fft_RADIX22FFT_CTRL1_5_block u_CTRL1_5_1 (.clk(clk),
                                                 .reset(reset),
                                                 .enb(enb),
  ...
  lora_fft_RADIX22FFT_SDF1_5_block u_SDF1_5_1 (.clk(clk),
                                               .reset(reset),
                                               .enb(enb),
  ...
  lora_fft_RADIX22FFT_CTRL1_6_block u_CTRL2_6_1 (.clk(clk),
                                                 .reset(reset),
                                                 .enb(enb),
                                                 .dout_5_1_vld(dout_5_1_vld),
  ...
  lora_fft_RADIX22FFT_SDF2_6_block u_SDF2_6_1 (.clk(clk),
                                               .reset(reset),
                                               .enb(enb),
                                               .dout_5_1_re(dout_5_1_re),  // sfix21_E1
                                               .dout_5_1_im(dout_5_1_im),  // sfix21_E1
  ...
  lora_fft_TWDLROM_7_1_block u_twdlROM_7 (.clk(clk),
                                          .reset(reset),
                                          .enb(enb),
                                          .dout_6_1_vld(dout_6_1_vld),
                                          .syncReset(syncReset),
  ...
  lora_fft_RADIX22FFT_CTRL1_1_block1 u_CTRLRX2 (.clk(clk),
                                                .reset(reset),
                                                .enb(enb),
  ...
  lora_fft_RADIX22FFT_SDF1_7_block u_RADIX2 (.clk(clk),
                                             .reset(reset),
                                             .enb(enb),
  ...
  lora_fft_RADIX2FFT_bitNatural_block u_NaturalOrder_Stage (.clk(clk),
                                                            .reset(reset),
                                                            .enb(enb),
                                                            .dout_7_re(dout_7_re),  // sfix23_E1
                                                            .dout_7_im(dout_7_im),  // sfix23_E1
