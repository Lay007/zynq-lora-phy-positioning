// -------------------------------------------------------------
// 
// File Name: G:\Programs\zynq-lora-phy-positioning\fpga\generated\fft-correlator-fixed\lora_fft_correlator_gen\lora_fft_Complex4Multiply_block.v
...
// -------------------------------------------------------------
// 
// Module: lora_fft_Complex4Multiply_block
// Source Path: lora_fft_correlator_gen/DUT/FFT_M/RADIX22FFT_SDF1_5/Complex4Multiply
// Hierarchy Level: 3
// Model version: 1.1
// 
// -------------------------------------------------------------
...
module lora_fft_Complex4Multiply_block
  ...
  input   reset;
  input   enb;
  input   signed [20:0] din_re;  // sfix21_En10
  input   signed [20:0] din_im;  // sfix21_En10
  input   din_5_vld_dly;
  input   signed [15:0] twdl_5_1_re;  // sfix16_En14
  input   signed [15:0] twdl_5_1_im;  // sfix16_En14
  input   syncReset;
  output  signed [20:0] dinXTwdl_re;  // sfix21_En10
  output  signed [20:0] dinXTwdl_im;  // sfix21_En10
  output  dinXTwdl_5_1_vld;


  reg signed [20:0] din_re_reg;  // sfix21_En10
  reg signed [20:0] din_im_reg;  // sfix21_En10
  ...
  reg signed [36:0] prod1_re;  // sfix37_En24
  reg signed [36:0] prod1_im;  // sfix37_En24
  reg signed [36:0] prod2_re;  // sfix37_En24
  reg signed [36:0] prod2_im;  // sfix37_En24
  reg  din_vld_dly1;
  reg  din_vld_dly2;
  reg  din_vld_dly3;
  reg  prod_vld;
  ...
  wire signed [37:0] Complex4Add_multRes_re_reg_next;  // sfix38_En24
  wire signed [37:0] Complex4Add_multRes_im_reg_next;  // sfix38_En24
  wire signed [37:0] Complex4Add_sub_cast;  // sfix38_En24
  wire signed [37:0] Complex4Add_sub_cast_1;  // sfix38_En24
  wire signed [37:0] Complex4Add_add_cast;  // sfix38_En24
  wire signed [37:0] Complex4Add_add_cast_1;  // sfix38_En24
  wire signed [37:0] mulResFP_re;  // sfix38_En24
  wire signed [37:0] mulResFP_im;  // sfix38_En24
...
endmodule  // lora_fft_Complex4Multiply_block
