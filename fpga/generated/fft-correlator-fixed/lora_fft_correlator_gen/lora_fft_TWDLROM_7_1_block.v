// -------------------------------------------------------------
// 
// File Name: G:\Programs\zynq-lora-phy-positioning\fpga\generated\fft-correlator-fixed\lora_fft_correlator_gen\lora_fft_TWDLROM_7_1_block.v
...
// -------------------------------------------------------------
// 
// Module: lora_fft_TWDLROM_7_1_block
// Source Path: lora_fft_correlator_gen/DUT/FFT_N/TWDLROM_7_1
// Hierarchy Level: 2
// Model version: 1.1
// 
// -------------------------------------------------------------
...
module lora_fft_TWDLROM_7_1_block
  ...
  always @(Radix22TwdlMapping_cnt, Radix22TwdlMapping_dvldReg1,
    ...
    case ( Radix22TwdlMapping_octant)
      ...
      3'b001 :
        begin
          ...
          Radix22TwdlMapping_sub_temp_0 = 9'sb000100000 - Radix22TwdlMapping_t_2_0;
      ...
      3'b010 :
        begin
          ...
          Radix22TwdlMapping_sub_temp_1 = Radix22TwdlMapping_t_1 - 9'sb000100000;
    ...
    if (Radix22TwdlMapping_phase == 2'b00) begin
      ...
      Radix22TwdlMapping_twdlAddr_raw_next = Radix22TwdlMapping_t_0_0 <<< 16'd1;
    end
...
endmodule  // lora_fft_TWDLROM_7_1_block
