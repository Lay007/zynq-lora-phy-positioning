// -------------------------------------------------------------
// 
// File Name: G:\Programs\zynq-lora-phy-positioning\fpga\generated\fft-correlator-fixed\lora_fft_correlator_gen\lora_fft_RADIX22FFT_SDF2_2.v
...
// -------------------------------------------------------------
// 
// Module: lora_fft_RADIX22FFT_SDF2_2
// Source Path: lora_fft_correlator_gen/DUT/FFT_M/RADIX22FFT_SDF2_2
// Hierarchy Level: 2
// Model version: 1.1
// 
// -------------------------------------------------------------
...
module lora_fft_RADIX22FFT_SDF2_2
  ...
  input   reset;
  input   enb;
  input   signed [16:0] dout_1_1_re;  // sfix17_En10
  input   signed [16:0] dout_1_1_im;  // sfix17_En10
  input   dout_1_1_vld;
  ...
  input   multiply_2_J;
  input   syncReset;
  output  signed [17:0] dout_2_1_re;  // sfix18_En10
  output  signed [17:0] dout_2_1_im;  // sfix18_En10
  output  dout_2_1_vld;
  output  dinXTwdl_2_1_vld;


  wire signed [17:0] din_re;  // sfix18_En10
  wire signed [17:0] din_im;  // sfix18_En10
  wire btfin_vld;
  wire saveEnb;
  wire dinVld;
  reg  x_vld;
  reg  x_vld_dly;
  wire signed [17:0] wrData_im;  // sfix18_En10
  wire [7:0] wrAddr;  // ufix8
  wire wrEnb;
  wire signed [17:0] x_im;  // sfix18_En10
  reg signed [17:0] x_im_dly;  // sfix18_En10
  wire signed [17:0] wrData_re;  // sfix18_En10
  wire signed [17:0] x_re;  // sfix18_En10
  reg signed [17:0] x_re_dly;  // sfix18_En10
  ...
  reg signed [18:0] Radix22ButterflyG2_btf1_re_reg_next;  // sfix19_En10
  reg signed [18:0] Radix22ButterflyG2_btf1_im_reg_next;  // sfix19_En10
  reg signed [18:0] Radix22ButterflyG2_btf2_re_reg_next;  // sfix19_En10
  reg signed [18:0] Radix22ButterflyG2_btf2_im_reg_next;  // sfix19_En10
  reg signed [17:0] Radix22ButterflyG2_din_re_dly_next;  // sfix18_En10
  reg signed [17:0] Radix22ButterflyG2_din_im_dly_next;  // sfix18_En10
  reg  Radix22ButterflyG2_din_vld_dly_next;
  reg signed [17:0] Radix22ButterflyG2_x_re_dly_next;  // sfix18_En10
  reg signed [17:0] Radix22ButterflyG2_x_im_dly_next;  // sfix18_En10
  reg  Radix22ButterflyG2_x_vld_dly_next;
  reg signed [17:0] Radix22ButterflyG2_dinXTwdl_re_dly1_next;  // sfix18_En10
  reg signed [17:0] Radix22ButterflyG2_dinXTwdl_im_dly1_next;  // sfix18_En10
  reg signed [17:0] Radix22ButterflyG2_dinXTwdl_re_dly2_next;  // sfix18_En10
  reg signed [17:0] Radix22ButterflyG2_dinXTwdl_im_dly2_next;  // sfix18_En10
  reg  Radix22ButterflyG2_multiply_J_dly1_next;
  reg signed [17:0] xf_re;  // sfix18_En10
  reg signed [17:0] xf_im;  // sfix18_En10
  reg  xf_vld;
  reg signed [17:0] dinf_re;  // sfix18_En10
  reg signed [17:0] dinf_im;  // sfix18_En10
  reg  dinf_vld;
  reg signed [17:0] btf1_re;  // sfix18_En10
  reg signed [17:0] btf1_im;  // sfix18_En10
  reg signed [17:0] btf2_re;  // sfix18_En10
  reg signed [17:0] btf2_im;  // sfix18_En10
  reg  btfout_vld;
  reg signed [18:0] Radix22ButterflyG2_add_cast;  // sfix19_En10
  reg signed [18:0] Radix22ButterflyG2_add_cast_0;  // sfix19_En10
  reg signed [18:0] Radix22ButterflyG2_add_cast_1;  // sfix19_En10
  reg signed [18:0] Radix22ButterflyG2_add_cast_2;  // sfix19_En10
  reg signed [18:0] Radix22ButterflyG2_sub_cast;  // sfix19_En10
  reg signed [18:0] Radix22ButterflyG2_sub_cast_0;  // sfix19_En10
  reg signed [18:0] Radix22ButterflyG2_sub_cast_1;  // sfix19_En10
  reg signed [18:0] Radix22ButterflyG2_sub_cast_2;  // sfix19_En10
  reg signed [18:0] Radix22ButterflyG2_add_cast_3;  // sfix19_En10
  reg signed [18:0] Radix22ButterflyG2_add_cast_4;  // sfix19_En10
  reg signed [18:0] Radix22ButterflyG2_add_cast_5;  // sfix19_En10
  reg signed [18:0] Radix22ButterflyG2_add_cast_6;  // sfix19_En10
  reg signed [18:0] Radix22ButterflyG2_sub_cast_3;  // sfix19_En10
  reg signed [18:0] Radix22ButterflyG2_sub_cast_4;  // sfix19_En10
  reg signed [18:0] Radix22ButterflyG2_sub_cast_5;  // sfix19_En10
  reg signed [18:0] Radix22ButterflyG2_sub_cast_6;  // sfix19_En10
  ...
  lora_fft_SimpleDualPortRAM_generic #(.AddrWidth(8),
                                       .DataWidth(18)
                                       )
  ...
  lora_fft_SDFCommutator2 u_SDFCOMMUTATOR_2 (.clk(clk),
                                             .reset(reset),
                                             .enb(enb),
                                             .dout_1_1_vld(dout_1_1_vld),
                                             .xf_re(xf_re),  // sfix18_En10
                                             .xf_im(xf_im),  // sfix18_En10
                                             .xf_vld(xf_vld),
                                             .dinf_re(dinf_re),  // sfix18_En10
                                             .dinf_im(dinf_im),  // sfix18_En10
                                             .dinf_vld(dinf_vld),
                                             .btf1_re(btf1_re),  // sfix18_En10
                                             .btf1_im(btf1_im),  // sfix18_En10
                                             .btf2_re(btf2_re),  // sfix18_En10
                                             .btf2_im(btf2_im),  // sfix18_En10
                                             .btfout_vld(btfout_vld),
                                             .syncReset(syncReset),
                                             .wrData_re(wrData_re),  // sfix18_En10
                                             .wrData_im(wrData_im),  // sfix18_En10
                                             .wrAddr(wrAddr),  // ufix8
                                             .wrEnb(wrEnb),
...
endmodule  // lora_fft_RADIX22FFT_SDF2_2
