// -------------------------------------------------------------
// 
// File Name: G:\Programs\zynq-lora-phy-positioning\fpga\generated\fft-correlator-fixed\lora_fft_correlator_gen\lora_fft_RADIX2FFT_bitNatural.v
...
// -------------------------------------------------------------
// 
// Module: lora_fft_RADIX2FFT_bitNatural
// Source Path: lora_fft_correlator_gen/DUT/FFT_M/RADIX2FFT_bitNatural
// Hierarchy Level: 2
// Model version: 1.1
// 
// -------------------------------------------------------------
...
module lora_fft_RADIX2FFT_bitNatural
  ...
  input   reset;
  input   enb;
  input   signed [25:0] dout_10_1_re;  // sfix26_En10
  input   signed [25:0] dout_10_1_im;  // sfix26_En10
  input   dout_10_1_vld;
  input   syncReset;
  output  signed [25:0] dout_re1;  // sfix26_En10
  output  signed [25:0] dout_im1;  // sfix26_En10
  output  dout_vld1;
  ...
  wire signed [25:0] memOut_im;  // sfix26_En10
  wire signed [25:0] memOut_re;  // sfix26_En10
  ...
  reg signed [25:0] rdStateMachineBitNatural_doutReReg_next;  // sfix26_En10
  reg signed [25:0] rdStateMachineBitNatural_doutImReg_next;  // sfix26_En10
  ...
  reg signed [25:0] dout_re1_1;  // sfix26_En10
  reg signed [25:0] dout_im1_1;  // sfix26_En10
  reg  dout_vld1_1;
  reg  startOutW;
  reg  endOutW;
  ...
  lora_fft_SimpleDualPortRAM_generic #(.AddrWidth(10),
                                       .DataWidth(26)
                                       )
...
endmodule  // lora_fft_RADIX2FFT_bitNatural
