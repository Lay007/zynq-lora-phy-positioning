...
`artifacts/` и большие IQ captures не добавляются в Git. Для значимого
эксперимента коммитятся заполненная конфигурация, компактные таблицы/графики и
SHA-256 внешних raw data.
