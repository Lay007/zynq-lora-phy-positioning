...
комплексной преамбулы с записью и аппроксимирует логарифм модуля корреляции тремя
точками параболы около целого максимума (`matched-filter-log-magnitude-v1`). Дополнительно возвращаются
