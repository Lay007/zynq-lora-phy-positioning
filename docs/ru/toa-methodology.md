...
комплексной преамбулы с записью и аппроксимирует логарифм модуля корреляции
тремя точками параболы около целого максимума с ограничением ±0,5 отсчёта
(`matched-filter-log-magnitude-v1`; в исходнике MATLAB приведено 0,0066
отсчёта RMS против 0,0625 у параболы по мощности). Дополнительно возвращаются
